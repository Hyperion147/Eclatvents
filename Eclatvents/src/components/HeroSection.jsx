...
const HeroSection = () => {
  ...
  return (
    <section className="relative bg-gray-50 py-20 md:py-32 flex items-center justify-center min-h-[50vh]">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col items-center justify-center text-center w-full">
          ...
          <button 
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 hover:shadow-lg shadow-blue-200/50 cursor-pointer mt-20"
          >
            Learn More
          </button>
        </div>
